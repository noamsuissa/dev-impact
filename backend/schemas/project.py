...
class MetricContext(BaseModel):
    ...
    frequency: Optional[
        Literal["daily", "weekly", "monthly", "annually", "one_time"]
    ] = None
    scope: Optional[str] = Field(
        None, description="e.g., '200 daily users', 'entire platform', 'team of 5'"
    )
...
class StandardizedProjectMetric(BaseModel):
    ...
    timeframe: Optional[str] = Field(
        None, description="e.g., '3 months', '6 months', '1 year', 'ongoing'"
    )
