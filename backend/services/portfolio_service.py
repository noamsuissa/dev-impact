...
class PortfolioService:
    ...
    async def update_portfolio(
        ...
        try:
            ...
            if existing.data[0]["user_id"] != user_id:
                raise HTTPException(
                    status_code=403,
                    detail="You don't have permission to update this portfolio",
                )
            ...
            fresh_portfolio_data = {
                "user": {
                    ...
                    "github": (
                        ...
                        if user_profile_data.get("github_username")
                        else None
                    ),
                },
                "profile": {
        ...
        try:
            ...
            if portfolio_id:
                ...
                if portfolio_check.data and portfolio_check.data["user_id"] != user_id:
                    raise HTTPException(
                        status_code=403,
                        detail="You don't have permission to unpublish this portfolio",
                    )
    ...
    async def get_published_portfolio(
        self,
        client: Client,
        username: str,
