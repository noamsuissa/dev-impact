    ...
    async def get_subscription_info(
        ...
        try:
            ...
            profile_result = (
                ...
                .select(
                    "subscription_type, subscription_status, cancel_at_period_end, current_period_end"
                )
                .eq("id", user_id)
                .single()
                .execute()
            ...
            portfolio_count = (
                len(portfolio_count_result.data) if portfolio_count_result.data else 0
            )
            ...
            project_count = (
                len(project_count_result.data) if project_count_result.data else 0
            )
            ...
            raise HTTPException(
                status_code=500, detail="Failed to get subscription info"
            )
