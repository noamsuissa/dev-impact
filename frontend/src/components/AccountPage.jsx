...
import { user as userClient, auth as authClient, userProfiles as userProfilesClient, profiles as profilesClient } from '../utils/client';
...
const AccountPage = ({ user, projects }) => {
  ...
  const loadSubscriptionInfo = async () => {
    try {
      const info = await profilesClient.getSubscriptionInfo();
  ...
  const handleCancelSubscription = async () => {
    ...
    try {
      await profilesClient.cancelSubscription();
